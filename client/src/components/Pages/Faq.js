...
class Faq extends Component {
  ...
  render() {
    return (
      <div>
        <Button color="link" onClick={this.toggle} style={{ marginBottom: '1rem' }}><i class="fas fa-angle-double-right"></i> <span className ="header"> Who is this for?</span> </Button>
...
<br />
        ...
        <Button color="link" onClick={this.toggle} style={{ marginBottom: '1rem' }}><i class="fas fa-angle-double-right"></i> <span className ="header"> How does this work?</span> </Button>
        <Collapse isOpen={this.state.collapse}>
...
<br />
        ...
        <Button color="link" onClick={this.toggle} style={{ marginBottom: '1rem' }}><i class="fas fa-angle-double-right"></i> <span className ="header"> Does this replace seeing a mental health professional?</span> </Button>
        <Collapse isOpen={this.state.collapse}>
...
<br />
        ...
        <Button color="link" onClick={this.toggle} style={{ marginBottom: '1rem' }}><i class="fas fa-angle-double-right"></i> <span className ="header"> Why don't I see my specific diagnosis on here?</span> </Button>
        <Collapse isOpen={this.state.collapse}>
